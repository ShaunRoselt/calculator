...
export function renderNavIcon(kind) {
  const icons = {
    ...
    settings: '<path d="M12 9a3 3 0 1 1 0 6 3 3 0 0 1 0-6Z" /><path d="m14.95 4.95-.72 1.8c.45.14.88.32 1.28.56l1.73-.76 1.18 1.18-.76 1.73c.24.4.42.83.56 1.28l1.8.72v1.68l-1.8.72a5.82 5.82 0 0 1-.56 1.28l.76 1.73-1.18 1.18-1.73-.76a5.82 5.82 0 0 1-1.28.56l-.72 1.8h-1.68l-.72-1.8a5.82 5.82 0 0 1-1.28-.56l-1.73.76-1.18-1.18.76-1.73a5.82 5.82 0 0 1-.56-1.28l-1.8-.72v-1.68l1.8-.72c.14-.45.32-.88.56-1.28l-.76-1.73 1.18-1.18 1.73.76c.4-.24.83-.42 1.28-.56l.72-1.8z" />'
  };
